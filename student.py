...
class Student:
    def __init__(self, root):
        ...
        # ===============Images==================================
        img10 = Image.open(
            r"C:\Users\sumit\Downloads\Facial_Recognition_Automatic_Attendance_System\Main_W_Facial_Recognition_Automatic_Attendance_System_Final_Year_Project\college_images\stident_header.jpg")
        ...
        title = Label(self.root, text="STUDENT MANAGEMENT SYSTEM", font=(
            "times new roman", 30, "bold"), bg="white", fg="crimson")
        ...
        img_logo = Image.open(
            r"C:\Users\sumit\Downloads\Facial_Recognition_Automatic_Attendance_System\Main_W_Facial_Recognition_Automatic_Attendance_System_Final_Year_Project\college_images\31-311346_oxford-university-logo.png")
        ...
        img20 = Image.open(
            r"C:\Users\sumit\Downloads\Facial_Recognition_Automatic_Attendance_System\Main_W_Facial_Recognition_Automatic_Attendance_System_Final_Year_Project\college_images\iStock-1163542789-945x630.jpg")
        ...
        std_Info_label_frame = LabelFrame(DataFrameLeft, padx=10, bd=2, relief=RIDGE, font=(
            "times new roman", 11, "bold"), fg="darkgreen", bg="white", text="Current Course Information")
        ...
        lbl_dep = Label(std_Info_label_frame, font=(
            "arial", 12, "bold"), text="Department:", bg="white")
        ...
        com_dep['value'] = ("Select Department", "Computer", "Mechnical",
        ...
        course_std = Label(std_Info_label_frame, font=(
            "arial", 12, "bold"), text="Courses:", bg="white")
        ...
        com_txtcourse_std['value'] = (
            "Select Course", "B.tech", "M.tech", "ME", "BE")
        ...
        comSemester = ttk.Combobox(std_Info_label_frame, textvariable=self.var_semester, state="readonly",
                                   font=("arial", 12, "bold"), width=17)
        comSemester['value'] = ("Select Semester", "Semster-1", "Semester-2", "Semester-3",
        ...
        std_personalData_label_frame = LabelFrame(DataFrameLeft, padx=10, pady=5, bd=2, relief=RIDGE, font=(
            "times new roman", 11, "bold"), fg="darkgreen", bg="white", text="Student Class Information")
        ...
        img30 = Image.open(
            r"C:\Users\sumit\Downloads\Facial_Recognition_Automatic_Attendance_System\Main_W_Facial_Recognition_Automatic_Attendance_System_Final_Year_Project\college_images\iStock-182059956_18390_t12.jpg")
        ...
        # =======table&search=====================================================================================
        Table_frame = LabelFrame(DataFrameRight, text="View Student Details & Search System", font=(
            "arial", 11, "bold"), bg="white", bd=3, relief=RIDGE)
        ...
        btnExit = Button(Table_frame, text="SEARCH", command=self.search_data, font=(
            "arial", 12, "bold"), width=10, bg="blue", fg="white")
        ...
        btnReset = Button(title, text="Back", command=self.go_back, font=(
    ...
    def generate_dataset(self):
        if (self.var_dep.get() == "Select Department" or self.var_course.get() == "Select Course" or self.var_year.get() == "Select Year" or self.var_semester.get() == "Select Semester" or self.var_roll.get() == "" or self.usertype.get() == ""):
            ...
            face_classified = cv2.CascadeClassifier(
                r"C:\Users\sumit\Downloads\Facial_Recognition_Automatic_Attendance_System\Main_W_Facial_Recognition_Automatic_Attendance_System_Final_Year_Project\haarcascade_frontalface_default.xml")
            ...
            while True:
                ...
                if face_cropped(frame) is not None:
                    ...
                    file_name_path = r"C:\Users\sumit\Downloads\Facial_Recognition_Automatic_Attendance_System\Main_W_Facial_Recognition_Automatic_Attendance_System_Final_Year_Project\collect_sample/user." + \
