...
class Login_Window:
    def __init__(self, root):
        ...
        img1 = Image.open(
            r"C:\Users\sumit\Downloads\Facial_Recognition_Automatic_Attendance_System\Main_W_Facial_Recognition_Automatic_Attendance_System_Final_Year_Project\college_images\cool-design-2.png")
        ...
        title = Label(bg_lbl, text="FACIAL RECOGNITION ATTENDANCE MANAGEMENT SYSTEM", font=(
        ...
        img10 = Image.open(
            r"C:\Users\sumit\Downloads\Facial_Recognition_Automatic_Attendance_System\Main_W_Facial_Recognition_Automatic_Attendance_System_Final_Year_Project\college_images\facialrecognition.png")
        ...
        frame = Frame(self.root, bg="magenta")
        frame.place(x=610, y=200, width=340, height=430)

        img1 = Image.open(
            r"C:\Users\sumit\Downloads\Facial_Recognition_Automatic_Attendance_System\Main_W_Facial_Recognition_Automatic_Attendance_System_Final_Year_Project\college_images\LoginIconAppl.png")
        ...
        txtuser = ttk.Entry(frame, textvariable=self.txtuser,
        ...
        txtpass = ttk.Entry(frame, textvariable=self.txtpass, font=(
            "times new roman", 15, "bold"), show="*")
        txtpass.place(x=40, y=220, width=270)

        # ======Icon Images=================
        img2 = Image.open(
            r"C:\Users\sumit\Downloads\Facial_Recognition_Automatic_Attendance_System\Main_W_Facial_Recognition_Automatic_Attendance_System_Final_Year_Project\college_images\login-icon-3058.png")
        ...
        img3 = Image.open(
            r"C:\Users\sumit\Downloads\Facial_Recognition_Automatic_Attendance_System\Main_W_Facial_Recognition_Automatic_Attendance_System_Final_Year_Project\college_images\lock-512.png")
        ...
        # LoginButton
        btn_login = Button(frame, text="Login", borderwidth=3, relief=RAISED, command=self.login, cursor="hand2", font=(
            "times new roman", 16, "bold"), fg="white", bg="red", activebackground="#B00857")
        btn_login.place(x=110, y=270, width=120, height=35)
        # registerbutton
        registerbtn = Button(frame, text="New User Register", command=self.rigister_window, font=(
            "times new roman", 10, "bold"), borderwidth=0, fg="white", bg="black", activeforeground="white", activebackground="black")
        registerbtn.place(x=10, y=320, width=160, height=30)

        # forgetpassbtn
        registerbtn = Button(frame, text="Forget Password", command=self.forgot_password_window, font=(
            "times new roman", 10, "bold"), borderwidth=0, fg="white", bg="black", activeforeground="white", activebackground="black")
        registerbtn.place(x=10, y=360, width=160, height=30)
    ...
    def login(self):
        if self.txtuser.get() == "" or self.txtpass.get() == "":
            ...
            messagebox.showinfo(
                "Success", "Welcome to the face recognition based attendence system", parent=self.root)
        else:
            conn = mysql.connector.connect(
                host="localhost", user="root", password="Bansiya@2002", database="facial_recognition")
            ...
            if row == None:
                messagebox.showerror(
                    "Error", "Inavalid Username & password", parent=self.root)
            else:
                open_main = messagebox.askyesno(
                    "YesNo", "Access only Authority Person", parent=self.root)
                if open_main > 0:
                    self.new_window = Toplevel(self.root)
    ...
    def reset_pass(self):
        if self.combo_securiy_Q.get() == "Select" or self.txt_security.get() == "" or self.txt_newpass == "":
            ...
            try:
                ...
                value = (self.txtuser.get(), self.combo_securiy_Q.get(),
                ...
                if row == None:
                    messagebox.showerror(
                        "Error", "Please select the correct security quetion/Enter answer", parent=self.root2)
                else:
    ...
    def forgot_password_window(self):
        if self.txtuser.get() == "":
            ...
            if row == None:
                messagebox.showerror(
                    "My Error", "Plaese enter the valid user name")
            else:
                conn.close()
                self.root2 = Toplevel()
...
class Register:
    def __init__(self, root):
        ...
        self.bg = ImageTk.PhotoImage(
            file=r"C:\Users\sumit\Downloads\Facial_Recognition_Automatic_Attendance_System\Main_W_Facial_Recognition_Automatic_Attendance_System_Final_Year_Project\college_images\employee_img2.jpg")
        bg_lbl = Label(self.root, image=self.bg)
        bg_lbl.place(x=0, y=0, relwidth=1, relheight=1)

        # ============left image==================
        self.bg1 = ImageTk.PhotoImage(
            file=r"C:\Users\sumit\Downloads\Facial_Recognition_Automatic_Attendance_System\Main_W_Facial_Recognition_Automatic_Attendance_System_Final_Year_Project\college_images\1_5TRuG7tG0KrZJXKoFtHlSg.jpeg")
        ...
        self.checkbtn = Checkbutton(frame, variable=self.var_check, text="I Agree The Terms & Conditions", bg='white', font=(
        ...
        b1 = Button(frame, text="Register Now", command=self.register_data, borderwidth=0,
                    cursor="hand2", font=("times new roman", 15, "bold"), bg='green', fg='white')
        ...
        b2 = Button(frame, text="Login", command=self.return_login, borderwidth=0,
    ...
    def register_data(self):
        if self.var_fname.get() == "" or self.var_email.get() == "" or self.var_securityQ.get() == "Select":
            ...
            messagebox.showerror(
                "Error", "Plaese agree our terms ane condition", parent=self.root)
        else:
            conn = mysql.connector.connect(
                host="localhost", user="root", password="Bansiya@2002", database="facial_recognition")
            my_cursor = conn.cursor()
            ...
            if row != None:
                messagebox.showerror(
                    "Error", "User already exist,plaese try another email", parent=self.root)
            else:
